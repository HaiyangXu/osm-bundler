...
bundlerExecutable = ''
if sys.platform == "win32": bundlerExecutable = os.path.join(distrPath, "software/bundler/bundler.exe")
else: bundlerExecutable = os.path.join(distrPath, "software/bundler/bundler")
