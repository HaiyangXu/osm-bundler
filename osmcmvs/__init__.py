...
pmvsExecutable = getExecPath(distrPath, "software/pmvs/pmvs2")
cmvsExecutable = getExecPath(distrPath, "software/cmvs/cmvs")
genOptionExecutable = getExecPath(distrPath, "software/pmvs/genOption")

bundlerBinPath = ''
if sys.platform == "win32": bundlerBinPath = os.path.join(distrPath, "software/bundler/")
else: bundlerBinPath = os.path.join(distrPath, "software/bundler/")
